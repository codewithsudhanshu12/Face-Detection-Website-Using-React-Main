      ...
      {image ? (
        ...
        <div className="newPostCard">
          <div className="addPost">
            <img
              src="https://w0.peakpx.com/wallpaper/228/414/HD-wallpaper-terminator-ai-adobe-illustrator-art-amoled-black-dark-dark-and-white-illustrator-red-and-dark-robot.jpg"
              alt=""
              className="avatar"
            />
